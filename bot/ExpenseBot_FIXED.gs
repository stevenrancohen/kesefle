...
const CATEGORY_MAP = [
  ...
  {"keywords":["גן ילדים","שכר לימוד","חוג לילדים","שיעור פרטי","צהרון","מעון יום","קייטנה"],"category":"חינוך","subcategory":"חינוך"},
