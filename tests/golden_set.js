...
const GOLDEN = [
  ...
  // 2026-06-17 audit additions — driving lessons (were DEFAULT / mis-hit 'מור')
  ['שיעור נהיגה 150', 'חינוך'], ['מורה לנהיגה 150', 'חינוך'],
  // speech therapy / didactic assessment (feminine form was misrouting to תקשורת)
  ['קלינאית תקשורת 300', 'בריאות'], ['אבחון דידקטי 1500', 'בריאות'],
  // investment + pension income (were DEFAULT; must book as income)
  ['דיבידנד 2000', 'הכנסות'], ['ריבית מהבנק 100', 'הכנסות'], ['רווח הון 5000', 'הכנסות'],
  ['קצבת פנסיה 5000', 'הכנסות'],
  // 2026-06-17 taxonomy coverage (were DEFAULT) + ambiguity guards (must STAY DEFAULT)
  ['קייטנת קיץ 800', 'חינוך'], ['סדנה 250', 'חינוך'], ['וובינר 120', 'חינוך'],
  ['ארקפה 22', 'אוכל'], ['קופי טו גו 15', 'אוכל'], ['יש חסד 200', 'אוכל'],
  ['קלאלית 50', 'בריאות'],
  ['ביט 50', 'DEFAULT'], ['יש 100', 'DEFAULT'], ['פפר 30', 'DEFAULT'],
  // traffic fines (were שונות; should match the covered government fines)
  ['קנס מהירות 500', 'ממשלה'], ['קנס תנועה 250', 'ממשלה'],
