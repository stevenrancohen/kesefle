...
```
"כסף'לה" הוא שירות לרישום הוצאות והכנסות. הוא אינו תחליף לייעוץ
...
"כסף'לה" יכולים להיות בסיס טוב לפגישה עם רואה חשבון או יועץ מס
...
<p>בגבול המותר על פי דין, "כסף'לה" ובעלי המניות, נושאי המשרה והעובדים שלה
