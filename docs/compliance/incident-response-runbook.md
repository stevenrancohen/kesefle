...
Subject: דיווח על אירוע אבטחת מידע — כספ'לה / SRC Solutions
...
"כספ'לה" (kesefle.app), בהתאם לתקנה 11 לתקנות הגנת הפרטיות
...
Subject: עדכון חשוב על אבטחת חשבון "כספ'לה" שלך

```
שלום,

ב-{תאריך}, גילינו אירוע אבטחה בשירות "כספ'לה" שעשוי להיות נוגע
...
בכבוד רב,
SRC Solutions, מפעילי שירות "כספ'לה"
```
